...
// 각기 다른 용량의 문서를 차례대로 인쇄하여
// 모든 문서가 인쇄되는데 최소 몇 초가 걸리는지 테스트하기로 했습니다.
//
//[제한사항]
...
//만약, 인쇄 작업 목록의 크기가 2이고 최대 용량이 10Kib 라면
// 크기가 [7, 4, 5, 6] Kib인 문서들이 최단 시간 안에 순서대로 모두 인쇄되는 과정은 다음과 같습니다.
